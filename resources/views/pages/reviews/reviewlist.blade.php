                    ...
                    <div class="col-2">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="star-rating">
                                    <input type="radio" id="star5" name="rating" value="5" disabled />
                                    <label for="star5" class="star {{ $review->reviewscore >= 5 ? 'filled' : '' }}"></label>
                                    <input type="radio" id="star4" name="rating" value="4" disabled />
                                    <label for="star4" class="star {{ $review->reviewscore >= 4 ? 'filled' : '' }}"></label>
                                    <input type="radio" id="star3" name="rating" value="3" disabled />
                                    <label for="star3" class="star {{ $review->reviewscore >= 3 ? 'filled' : '' }}"></label>
                                    <input type="radio" id="star2" name="rating" value="2" disabled />
                                    <label for="star2" class="star {{ $review->reviewscore >= 2 ? 'filled' : '' }}"></label>
                                    <input type="radio" id="star1" name="rating" value="1" disabled />
                                    <label for="star1" class="star {{ $review->reviewscore >= 1 ? 'filled' : '' }}"></label>
                                </div>
                            </div>
                        </div>
                    </div>
